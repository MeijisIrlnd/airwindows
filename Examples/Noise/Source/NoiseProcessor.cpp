...
void NoiseProcessor::setParam(PARAMETER p, float v)
{
...
void NoiseProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
    sr = sampleRate;
}

void NoiseProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
