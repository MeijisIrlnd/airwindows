...
GalacticProcessor::GalacticProcessor()
{
	paramBindings = {
		{Replace, &A},
		{Brightness, &B},
...
void GalacticProcessor::setParam(PARAMS p, double value)
{
...
void GalacticProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
	sr = sampleRate;
}

void GalacticProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
...
void GalacticProcessor::releaseResources()
{
