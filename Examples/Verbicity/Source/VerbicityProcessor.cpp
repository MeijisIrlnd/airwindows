...
VerbicityProcessor::VerbicityProcessor()
{
	paramBindings = {
		{Bigness, &A},
		{Loudness, &B},
...
void VerbicityProcessor::setParam(PARAMS p, double value)
{
...
void VerbicityProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
	sr = sampleRate;
}

void VerbicityProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
...
void VerbicityProcessor::releaseResources()
{
