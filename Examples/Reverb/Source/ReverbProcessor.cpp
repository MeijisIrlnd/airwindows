...
void ReverbProcessor::setParam(PARAMETER p, float value)
{
...
void ReverbProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
	sr = sampleRate;
}

void ReverbProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
	...
	biquadC[0] = biquadB[0] = biquadA[0] = (10000.0 - (big * wet * 3000.0)) / sr;
