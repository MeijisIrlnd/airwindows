...
GlitchShifterProcessor::GlitchShifterProcessor()
{
    paramBindings =
    {
        {NOTE, &A},
...
void GlitchShifterProcessor::setParam(PARAMETER p, float value)
{
...
void GlitchShifterProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
	sr = sampleRate;
}

void GlitchShifterProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
...
void GlitchShifterProcessor::releaseResources()
{
