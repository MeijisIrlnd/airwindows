...
void MeltProcessor::setParam(PARAMETER p, float v)
{
...
void MeltProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
    sr = sampleRate;
}

void MeltProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
...
void MeltProcessor::releaseResources()
{
