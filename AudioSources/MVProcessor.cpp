...
void MVProcessor::setParam(PARAMETER p, float v)
{
...
void MVProcessor::prepareToPlay(int samplesPerBlockExpected, double sampleRate)
{
    sr = sampleRate;
}

void MVProcessor::getNextAudioBlock(const juce::AudioSourceChannelInfo& bufferToFill)
{
...
void MVProcessor::releaseResources()
{
